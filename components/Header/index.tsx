    ...
    >
      <div className="max-w-c-1390 relative mx-auto items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        <div className="flex w-full items-center justify-between xl:w-1/4">
          <a href="/" className="block flex h-10 items-center overflow-hidden">
            <Image
              src="/images/logo/logo-light_2.png"
              alt="logo"
              width={160}
              height={50}
              priority
              className="hidden h-16 w-auto scale-115 object-contain dark:block"
            />
            <Image
              src="/images/logo/logo-light_2.png"
              alt="logo"
              ...
              height={50}
              priority
              className="block h-16 w-auto scale-115 object-contain dark:hidden"
            />
          </a>
